...
// DECOY_ACCOUNTS should now be loaded dynamically from the database via /api/decoy/accounts
// Fetch from the API in your components instead of importing this constant
// Example: const response = await fetch('/api/decoy/accounts')
//
